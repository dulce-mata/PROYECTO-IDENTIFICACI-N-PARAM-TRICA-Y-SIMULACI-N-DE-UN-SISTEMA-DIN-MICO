...
//****************ENCODER PULSES************************************
int PPR=130.0; //Pulse Per Rotation-Measured manually-see youtube video
...
float Vmin = 0;
float V = 8;         // Motor voltage input. Set voltage to step amplitud 
...
void loop() {
 /* if (count > count_prev) {
    ...
    if((currentMillis - previousMillis) >= interval)
    {
      ...
      //RPM_output = 10*EncoderCount*(60.0/374.0);
      RPM_output = RPM_output = 10*EncoderCount*(60.0/528.0);;
      //RPM_output = EncoderCount; // RPM del eje principal
      EncoderCount = 0;
    }
